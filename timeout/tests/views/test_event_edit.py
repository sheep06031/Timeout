...
class EventEditViewTests(TestCase):
    ...
    def test_other_user_gets_404_on_get(self):
        """A user who is not the event creator should receive a 404 on GET."""
        self.client.logout()
    ...
    def test_other_user_gets_404_on_post(self):
        """A user who is not the event creator should receive a 404 on POST."""
        self.client.logout()
        self.client.login(username='other', password='password')
    ...
    def test_post_updates_description(self):
        """A POST request with new data should update the event description."""
    ...
    def test_post_updates_event_type(self):
        """A POST request with new data should update the event type."""
    ...
    def test_post_updates_location(self):
        """A POST request with new data should update the event location."""
    ...
    def test_post_invalid_start_datetime_redirects_to_calendar(self):
        """If the start_datetime is invalid, should redirect to calendar with an error message."""
    ...
    def test_post_invalid_end_datetime_redirects_to_calendar(self):
        """If the end_datetime is invalid, should redirect to calendar with an error message."""
    ...
    def test_post_invalid_datetime_shows_error_message(self):
        """If the datetime is invalid, should show an error message."""
        data = self._post_data(start_datetime='not-a-date')
    ...
    def test_post_invalid_datetime_does_not_update_event(self):
        """If the datetime is invalid, the event should not be updated."""
    ...
    def test_post_deadline_sets_linked_study_sessions(self):
        """When editing a deadline, linked_study_sessions should be updated based on the POST data."""
